		...
		<div id="manager-wrapper">
			<div id="body-wrapper">
				<div>
					...
					<div style="float:right;margin-top:-2px;"><a href="?logout" title="Log out"><img src="//i.animeftw.tv/new-icons/logout_new.png" alt="" style="width:20px;" /></a></div>
					</div>
				</div>
	...
	private function headerCode()
	{
		...
		if($this->ValidatePermission(2) == TRUE)
		{
			...
			<a href="#" id="nav-users" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_users.png" height="25px" alt="" title="Manage Users" />
						</div>
						<div class="nav-text">
							Users
						</div>
		...
		if($this->ValidatePermission(10) == TRUE)
		{
			...
			<a href="#" id="nav-comments" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_comments.png" height="25px" alt="" title="Manage Comments" />
						</div>
						<div class="nav-text">
							Comments
						</div>
		...
		if($this->ValidatePermission(17) == TRUE)
			...
			<div style="padding:4px;">
				<a href="#" id="nav-episodes" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_episodes.png" height="25px" alt="" title="Manage Episodes" />
						</div>
						<div class="nav-text">
							Episodes
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-series" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_series.png" height="25px" alt="" title="Manage Series" />
						</div>
						<div class="nav-text">
							Series
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-applications" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_applications.png" height="25px" alt="" title="Manage Applications" />
						</div>
						<div class="nav-text">
							Apps
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-errors" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_error_reports.png" height="25px" alt="" title="Manage Error Reports" />
						</div>
						<div class="nav-text">
							Errors
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-reviews" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_reviews.png" height="25px" alt="" title="Manage Reviews" />
						</div>
						<div class="nav-text">
							Reviews
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-emails" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_mail.png" height="25px" alt="" title="Manage Emails" />
						</div>
						<div class="nav-text">
							Emails
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-logs" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_logs.png" height="25px" alt="" title="Manage Site Logs" />
						</div>
						<div class="nav-text">
							Logs
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-watchlist" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_my_watchlist.png" height="25px" alt="" title="Manage My WatchList Entries" />
						</div>
						<div class="nav-text">
							My WatchList
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-forums" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_forum_objects.png" height="25px" alt="" title="Manage Forum Posts and Threads" />
						</div>
						<div class="nav-text">
						Forums
						</div>
			...
			<div style="padding:4px;">
				<a href="#" id="nav-settings" class="manager-nav">
					<div class="nav-item">
						<div class="nav-image">
							<img src="//i.animeftw.tv/management/manage_settings.png" height="25px" alt="" title="Manage Settings" />
						</div>
						<div class="nav-text">
							Settings
						</div>
			...
			if($this->ValidatePermission(79) == TRUE)
			{
				...
				<div style="padding:4px;">
					<a href="#" id="nav-store" class="manager-nav">
						<div class="nav-item">
							<div class="nav-image">
								<img src="//i.animeftw.tv/storeimages/shopping_basket.png" height="25px" alt="" title="Manage Store" />
							</div>
							<div class="nav-text">
								Store
							</div>
			...
			if($this->ValidatePermission(91) == TRUE)
			{
				...
				<div style="padding:4px;">
					<a href="#" id="nav-content" class="manager-nav">
						<div class="nav-item">
							<div class="nav-image">
								<img src="//i.animeftw.tv/management/manage_applications.png" height="25px" alt="" title="Manage Content" />
							</div>
							<div class="nav-text">
								Content
							</div>
			...
			if($this->ValidatePermission(92) == TRUE)
			{
				...
				<div style="padding:4px;">
					<a href="#" id="nav-stats" class="manager-nav">
						<div class="nav-item">
							<div class="nav-image">
								<img src="//i.animeftw.tv/management/management_stats.png" height="25px" alt="" title="Manage Stats" />
							</div>
							<div class="nav-text">
								Stats
							</div>
			...
			$header .= '
				<div style="padding:4px;">
					<a href="#" id="nav-uploads" class="manager-nav">
						<div class="nav-item">
							<div class="nav-image">
								<img src="//i.animeftw.tv/new-icons/uploads_new.png" height="25px" alt="" title="Uploads Interface" />
							</div>
							<div class="nav-text">
								Uploads
							</div>
