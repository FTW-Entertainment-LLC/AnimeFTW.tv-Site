...
else if($_GET['node'] == 'password-confirm' && 2 == 1)
{
    ...
    echo '<div align="center"><form id="form1" action="'.$_SERVER['REQUEST_URI'].'" method="post">
		...
		echo '<div align="center">As the site has grown, so has our offering, many users asked us, how could we support the site, one the devoted itself to the highest quality anime on the net. After much thought, we came up with the Advanced Member Title. Since the conception of the Advanced Member, we have evolved the status to something more. FTW Subscribers, users who are a FTW Subscriber have access to all of the premium benefits on all of FTW Entertainment LLC\'s Sites, Being an Advanced Member is a Subsidary of this overall perk.</div> <br /><br />
				...
				<div align="left"><a href="//animeftw.tv/images/externalamdownloadnew.png" target="_blank"><img src="//animeftw.tv/images/externalamdownloadnew.png" width="350" alt="External AM downloads" style="float:left;" /></a><br /><b>Know What episodes you love?</b> <br />Download them from the episodes listing in a flash!</div><br /><br /><br /><br />
				<div align="right"><a href="//animeftw.tv/images/AMstatus.png" target="_blank"><img src="//animeftw.tv/images/AMstatus.png" width="350" alt="AM Status" style="float:right;" /></a><b>Like to let people know of your current doings?</b> <br />Set your status on your profile page!</div><br /><br /><br />
				<div align="left"><a href="//animeftw.tv/images/personalamsettings.png" target="_blank"><img src="//animeftw.tv/images/personalamsettings.png" height="300" alt="AM Profiles" style="float:left;" /></a><br /><b>Love profiles?</b> <br />With even more options for your account, go nuts!</div><br /><br /><br /><br /><br /><br /><br />
				<div align="right"><a href="//animeftw.tv/images/html5video.png" target="_blank"><img src="//animeftw.tv/images/html5video.png" width="350" alt="HTML5 Player" style="float:right;" /></a><b>Want to use the HTML5 Video player?</b> <br />Choose to keep the DivX player, or start using the HTML5 player right away!</div><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
				<div align="left"><a href="//animeftw.tv/images/sslsupport.png" target="_blank"><img src="//animeftw.tv/images/sslsupport.png" width="350" alt="Site Wide SSL Support" style="float:left;" /></a><br /><b>Don\'t want someone snooping on your anime?</b> <br />Use AnimeFTW.tv securely, on ALL pages!</div><br />
				<br /><br />
  ...
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center"><img src="//animeftw.tv/images/checkmark.gif" alt="check mark" /></td>
    <td align="center"><img src="//animeftw.tv/images/checkmark.gif" alt="check mark" /></td>
  </tr>
  <tr bgcolor="#CCCCCC">
			   ...
			   //Pull the respective Series ID number and get the series info and name..
				...
				if($reviews == 0)
				{
				   ...
				   echo '<div class="mpart">
					...
					$reviewInfo = mysqli_fetch_array($reviewsquery);
