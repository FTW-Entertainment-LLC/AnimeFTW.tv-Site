...
//$index_global_message = "NOTICE! The Member Pages are still under development, please be aware that things are still set statically for design purposes.";
	...
	if($IsThereAUser == 1){
		...
		echo "<div class='linfo'><span id=\"friendscheck\">Loading..</span></div>";
		...
		echo "
				...
				$('#friendscheck').load('/scripts.php?view=profile&subview=friendbutton&id=".$u->UserArray['ID']."&add=before');
				</script>
