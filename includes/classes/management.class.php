	...
	private function TopNav(){
		if($this->ValidatePermission(1) == TRUE){
			...
			if($this->ValidatePermission(2) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=users\'); return false;"><img src="/images/management/manage_users.png" height="25px" alt="" title="Manage Users" /></a></div>';
			}
			if($this->ValidatePermission(10) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=comments\'); return false;"><img src="/images/management/manage_comments.png" height="25px" alt="" title="Manage Comments" /></a></div>';
			}
			if($this->ValidatePermission(17) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=episodes\'); return false;"><img src="/images/management/manage_episodes.png" height="25px" alt="" title="Manage Episodes" /></a></div>';
			}
			if($this->ValidatePermission(21) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=series\'); return false;"><img src="/images/management/manage_series.png" height="25px" alt="" title="Manage Series" /></a></div>';
			}
			if($this->ValidatePermission(26) == TRUE){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=applications\'); return false;"><img src="/images/management/manage_applications.png" height="25px" alt="" title="Manage Applications" /></a></div>';
			}
			if($this->ValidatePermission(30) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=errors\'); return false;"><img src="/images/management/manage_error_reports.png" height="25px" alt="" title="Manage Error Reports" /></a></div>';
			}
			if($this->ValidatePermission(33) == TRUE){
				...
				echo '<div style="display:inline-block;"><div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=reviews\'); return false;"><img src="/images/management/manage_reviews.png" height="25px" alt="" title="Manage Reviews" /></a></div>' . $reviewCount . '</div>';
			}
			if($this->ValidatePermission(38) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=mail\'); return false;"><img src="/images/management/manage_mail.png" height="25px" alt="" title="Manage Emails" /></a></div>';
			}
			if($this->ValidatePermission(41) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=logs\'); return false;"><img src="/images/management/manage_logs.png" height="25px" alt="" title="Manage Site Logs" /></a></div>';
			}
			if($this->ValidatePermission(44) == TRUE && 1 == 2){
				echo '<div style="display:inline-block;"><a href="#" rel="#manage" onClick="javascript:ajax_loadContent(\'manageedit\',\'/scripts.php?view=management&u='.$this->uid.'&node=mywatchlist\'); return false;"><img src="/images/management/manage_my_watchlist.png" height="25px" alt="" title="Manage My WatchList Entries" /></a></div>';
			}
			if($this->ValidatePermission(48) == TRUE){
					...
					if ($count>0) {
						...
						while($myrow = mysql_fetch_array($result))
						{
							...
							if($this->ValidatePermission(12) == TRUE){
								...
								echo "<img src='http://www.animeftw.tv/images/editor/edit.gif' width='16' height='15' alt='edit' border='0' />";
								echo "</a>";
								echo "</td>";
							}
							else {
							...
							if($this->ValidatePermission(13) == TRUE){
								...
								echo "<img src='http://www.animeftw.tv/images/editor/delete.gif' width='16' height='15' alt='delete' border='0' />";
								echo "</a>";
								echo "</td>\n";
							}
							else {
	...
	private function ManageEpisodes(){
		...
		if(!isset($_GET['eid']) && !isset($_GET['edit'])){
			...
			while($r = mysql_fetch_array($result)){
				...
				echo '<div class="eactioncol" align="center" '.$style.'><a href="#" onClick="javascript:ajax_loadContent(\'manageedit\',\''.$link.'&eid='.$r['id'].'&stage=before\'); return false;" title="Edit this Episode"><img src="/images/editor/edit.gif" height="11px" alt="" /></a> | <a href="#"><img src="/images/editor/delete.gif" alt="" height="11px" /></a>'.$addImageIcon.'</div>';
				echo '</div>';
				$i++;
			}
			echo '</div>';
					...
					<table width="620" border="0" cellpadding="2" cellspacing="1" align="center">
						...
						<tr> 
							...
							<td>
								<table>
								<tr>
									<td><div align="center"><img src="/images/ratings/e.jpg" alt="Everyone" /><br /><input type="radio" name="ratingLink" value="e.jpg" '; if($ratingLink == 'e.jpg'){echo 'checked="checked"';} echo ' /></td></div></td>
									<td><div align="center"><img src="/images/ratings/12+.jpg" alt="12+" /><br /><input type="radio" name="ratingLink" value="12+.jpg" '; if($ratingLink == '12+.jpg'){echo 'checked="checked"';} echo '  /></td></div></td>
									<td><div align="center"><img src="/images/ratings/15+.jpg" alt="15+" /><br /><input type="radio" name="ratingLink" value="15+.jpg" '; if($ratingLink == '15+.jpg'){echo 'checked="checked"';} echo '  /></td></div></td>
									<td><div align="center"><img src="/images/ratings/18+.jpg" alt="18+" /><br /><input type="radio" name="ratingLink" value="18+.jpg" '; if($ratingLink == '18+.jpg'){echo 'checked="checked"';} echo '  /></td></div></td>
								</tr>
							</table>
						</tr>
						<tr><td colspan="2" class="fontcolor">&nbsp;</td></tr>
