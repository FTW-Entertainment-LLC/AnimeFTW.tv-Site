	...
	private function Episode_Display($SeriesArray,$EpisodeArray,$SpriteArray,$moevar)
	{
		...
		else
		{
			...
			if(@array_key_exists($EpisodeArray[15],$this->RecentEps))
			{
				...
				if($this->RecentEps[$EpisodeArray[15]]['updated'] < (time()-2419200) || ((is_numeric($this->RecentEps[$EpisodeArray[15]]['max']) && is_numeric($this->RecentEps[$EpisodeArray[15]]['max']) > 0) && ($this->RecentEps[$EpisodeArray[15]]['time']/$this->RecentEps[$EpisodeArray[15]]['max'])*100 > 95))
				{
