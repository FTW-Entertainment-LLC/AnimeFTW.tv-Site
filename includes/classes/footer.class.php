...
class AFTWFooter extends Config {
	...
	public function Output(){
		...
		if($this->UserArray[8] == 1){
			echo "<img src='//i.animeftw.tv/holiday/christmas/footer-mascot.png' alt='footer-mascot' border='0' style='position:relative;z-index:1;' />";
		}
		else {
			echo "<img src='//i.animeftw.tv/birthday/AnimeFTW_FooterFolks_Party.jpg' alt='footer-mascot' border='0' style='position:relative;z-index:1;' />";
		}
		echo "</td>\n";
		echo "</tr>\n</table>\n";
...
<a href='http://ipv6-test.com/validate.php?url=referer'><img src='//i.animeftw.tv/button-ipv6-80x15.png' alt='ipv6 ready' title='AnimeFTW.tv ipv6 ready' border='0' /></a></div>";
		echo "</tr>\n</table>\n";
		echo "</td>\n";
		echo "</tr>\n</table>\n";
	}
