					...
					if ($start_point == 0 || !isset($_GET['s']))
					{
						...
						$start_point2 = $start_point-1;
							...
							if ($Logged != 1)
							{
								...
								{
								echo "<span class='forumbottons'><a href='/forums/post/reply-$tid'><img align='middle' src='/images/forumimages/closed.jpg' alt='post reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
								}
								else {
									echo "<span class='forumbottons'><img align='middle' src='/images/forumimages/closed.jpg' alt='post reply' style='margin-bottom:5px;' /></span>&nbsp;&nbsp;";
								}
							...
							echo "<span class='forumbottons'><a href='/forums/post/reply-$tid'><img align='middle' src='/images/forumimages/postreply.jpg' alt='post reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
								$query = "SELECT fid FROM forums_forum WHERE fid='$requestedForum' AND fpermpost LIKE '%$profileArray[2]%'";
								$result = mysql_query($query) or die('Error : ' . mysql_error());
								$row = mysql_fetch_array($result);
								$allowedToMakeNewTopic2 = $row['fid'];
	...
	echo "<td valign=\"middle\" class=\"row2\" width=\"1%\"><a name=\"entry$pid\"></a>";
								...
								$query002 = "SELECT Username, Level_access, firstName, gender, country, avatarActivate, personalMsg, avatarExtension, memberTitle, advanceImage, signatureActive, Signature FROM users WHERE ID='$tpid'";
									...
									echo "<div id=\"post-member\" class='popmenubutton-new-out'>
										...
										if ($gender002 == '')
										{
											echo "<img src='/images/gender-unknown.png' alt='' border='0' title='gender unknown' />&nbsp;";
										}
										else
										{
											echo "<img src='/images/$gender002.gif' alt='' border='0' />&nbsp;";
										}
						...
						echo "</span>
							...
							<td class=\"row2\" valign=\"middle\" width=\"99%\">
								...
								//thread date section
									...
									echo "<span class=\"postdetails\"> <img src='/images/forumimages/to_post_off.gif' alt='post' border='0' style='padding-bottom:2px' /> $tdate1</span>";
									if($profileArray[2] == 1 || $profileArray[2] == 2)
									{
					...
					<div class='postdetails_new' align='center'>
								<span class=\"postdetails\">
										...
										{
											echo '<img src="http://www.animeftw.tv/images/avatars/user'.$tpid.'.'.$avatarExtension002.'" alt="" />';
										}
										else {
											echo '<img src="http://www.animeftw.tv/images/avatars/default.gif" alt="" />';
										}
										echo "</a><br /><br />";
									if ($memberTitle002 != 'none')
									{
										...
										echo '<img src="http://'.$siteroot.'/images/'.$memberTitle002.'.jpg" alt="" border="0" /><br />';
									}
									else
									{
									}
			...
			{
				echo "<div align='right'><span class='forumbottons'><a href='/forums/edit/post-$pid'><img align='middle' src='/images/forumimages/useredit.jpg' alt='Edit your post' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;</div>";
			
			}
			else if ($profileArray[2] == 1 || $profileArray[2] == 2)
			{
			echo "<div align='right'><span class='forumbottons'><a href='/forums/edit/post-$pid'><img align='middle' src='/images/forumimages/adminedit.jpg' alt='post reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;</div>";
			}
			else {
			echo "&nbsp;";
			}		
...
if($puid == $profileArray[1]) {
    ...
    echo "</div>\n";
	echo "<div style='float: right;'><img src='/images/forumimages/to_post_off.gif' alt='on' border='0' style='padding-bottom:2px' /> ".$pdate1." &bull; ".$IpAddress1." Post <a href='#' onclick='link_to_post($pid); return false;' title='Show the link to this post'>#".$ptispost."</a> &bull; <a href='javascript:scroll(0,0);'>Top</a></div>\n";
	echo "</td>\n";
...
if($avatarActivate003 == yes) { 
    echo "<img src='http://www.animeftw.tv/images/avatars/user".$puid.'.'.$avatarExtension003."' alt='User Avatar' /><br /><br />\n";
  } else { 
    echo "<img src='http://www.animeftw.tv/images/avatars/default.gif' alt='User Avatar' /><br /><br />\n";
  }
    echo "<span class='small'>";
if ($memberTitle003 == 'none') { } 
    elseif ($personalMsg003 != '') { echo $personalMsg003."<br />\n<br />"; } 
	else { echo "<img src='/images/".$memberTitle003.".jpg' alt='Member Title' border='0' />\n"; }
    echo "</span><br /><br />\n";
	echo "</div>\n";
	echo "<div align='left'>\n";
...
if ($signatureActive003 == yes && $Level_access003 != 3) {
	...
	echo "<div style='float: left;'><a href='javascript:scroll(0,0);'>Top</a> &bull; Post <a href='#' onclick='link_to_post($pid); return false;' title='Show the link to this post'>#".$ptispost."</a> &bull; ".$IpAddress1." <img src='/images/forumimages/to_post_off.gif' alt='On' border='0' style='padding-bottom:2px' /> ".$pdate1."</div>\n";
...
$initialPost2++;
					...
					# END PAGING
							...
							if ($profileArray[0] != 1)
							{
								...
								{
								echo "
								<span class='forumbottons'><a href='javascript:toggle_visibility(\"QuickReply\");'><img align='middle' src='/images/forumimages/fastreply.jpg' alt='quick reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
								echo "<span class='forumbottons'><a href='/forums/post/reply-$tid'><img align='middle' src='/images/forumimages/closed.jpg' alt='post reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
								}
								else {
									echo "<span class='forumbottons'><img align='middle' src='/images/forumimages/closed.jpg' alt='post reply' style='margin-bottom:5px;' /></span>&nbsp;&nbsp;";
							...
							echo"<span class='forumbottons'><a href='javascript:toggle_visibility(\"QuickReply\");'><img align='middle' src='/images/forumimages/fastreply.jpg' alt='quick reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
							echo "<span class='forumbottons'><a href='/forums/post/reply-$tid'><img align='middle' src='/images/forumimages/postreply.jpg' alt='post reply' style='margin-bottom:5px;' /></a></span>&nbsp;&nbsp;";
								$query = "SELECT * FROM forums_forum WHERE fid='$requestedForum' AND fpermpost LIKE '%$PermissionLevelAdvanced%'";
								$result = mysql_query($query) or die('Error : ' . mysql_error());
								$row = mysql_fetch_array($result);
